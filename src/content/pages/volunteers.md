...
Alaska Pacific University. Its nordic program coaches and races at the national level.
:::

::::callout[Help out]{icon="handshake" tone="note"}
We always need more adults. The three most useful things:

:::points
- **Drive.** Practice meets at trailheads all over town and we carpool from East High. One driver with a few empty seats is the difference between an off-site practice happening and not.
- **Train with the group.** Run, ride, or ski at whatever pace you have. On long days the group strings out for miles, and we want an adult near the front and another near the back.
- **Teach something.** Strength, technique, nutrition, navigation, trail sense. If you know it, the kids can use it.
:::
::::

You don't need a coaching certificate or any ski background; we'll find you a job. Graduates home from college are especially welcome to train with the team and help lead it. [Reach out](/contact).
